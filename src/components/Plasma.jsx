...
void mainImage(out vec4 o, vec2 C) {
  ...
  for (int j = 0; j < 30; j++) {
    ...
    vec4 m4 = cos(p.y + vec4(0, 11, 33, 0) - T);
    mat2 m = mat2(m4.x, m4.y, m4.z, m4.w);
    p.xz *= m;
...
export const Plasma = ({
  ...
  return <div ref={containerRef} className="w-full h-full overflow-hidden absolute inset-0 pointer-events-none" />;
};
