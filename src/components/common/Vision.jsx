                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
                    ...
                    <div className="lg:col-span-4 flex flex-col items-center lg:items-start gap-10 lg:sticky lg:top-32 text-center lg:text-left">
                        ...
                        <div className="space-y-6 lg:space-y-8">
                            <h3 className="text-3xl md:text-4xl lg:text-3xl font-bold tracking-tight text-white/90">
                                Architecting <br />
                                <span className="italic font-serif font-light text-gray-500">Digital legacies.</span>
                            </h3>
                    ...
                    <div className="lg:col-span-8 space-y-12 lg:space-y-16">
                        <div className="relative">
                            ...
                            >
                                REDEFINING THE DIGITAL AVANT-GARDE.
                            </ScrollReveal>
                        </div>
                        ...
                        <div className="max-w-2xl mx-auto lg:ml-auto lg:mr-0 text-center lg:text-right">
                            ...
                            >
                                Where technology bows to artistry. We architect digital experiences that resonate with the pulse of modern elegance, transforming bold visions into seamless realities.
                            </ScrollReveal>
                        </div>
                        ...
                        <div className="pt-12 lg:pt-16 grid grid-cols-1 sm:grid-cols-3 gap-y-10 sm:gap-y-16 gap-x-12">
                            {[
                                { label: 'Craftsmanship', val: 'Precision-First' },
                                { label: 'Engineering', val: 'Performance-Core' },
                                { label: 'Philosophy', val: 'Avant-Garde' },
                            ].map((item, i) => (
                                <div key={i} className="group relative pt-6 sm:pt-0 sm:pl-6 flex flex-col items-center sm:items-start text-center sm:text-left">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <span className="text-[9px] uppercase tracking-[0.5em] text-gray-500 font-black transition-colors duration-300 group-hover:text-[#cc00cc]/80">
                                            {item.label}
                                        </span>
