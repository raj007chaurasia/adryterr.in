        ...
        >
            ...
            <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-16 lg:gap-24 relative z-10">
                ...
                <div className="flex-1 text-left">
                    ...
                    >
                        How <span className="font-playfair italic font-black text-[#cc00cc]" style={{ fontFamily: "'Playfair Display', serif" }}>Colleagues</span> Turned <br />
                        Into <span className="font-playfair italic font-black text-[#cc00cc]" style={{ fontFamily: "'Playfair Display', serif" }}>Co-Founders</span>
                    </motion.h2>
                    ...
                    >
                        Meet Atiq and Noman, the founders of AdRyter. Their journey began as colleagues, united by a shared vision. In 2021, they decided to launch their own venture after working together on major projects for brands like Viber and Samsung. Now, AdRyter is home to over 40 passionate team members, all dedicated to our mission.
                    </motion.p>
